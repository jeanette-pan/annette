          ...
          <>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-white/60 p-6 space-y-4">
              ...
              >
                ...
                <div className={`w-10 h-5 rounded-full transition-all duration-200 flex items-center ${form.isShared ? 'bg-green-400' : 'bg-gray-300'}`}>
                  <div className={`w-4 h-4 bg-white rounded-full shadow transition-all duration-200 ${form.isShared ? 'ml-5' : 'ml-0.5'}`} />
                </div>
              </button>
